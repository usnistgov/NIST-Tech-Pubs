...
Date of data collection: 20201029 
...
File List
   A. Filename: allrecords_oct292020.xml       
...
Relationship between files: allrecords_oct292020.xml was transformed to NIST_Tech_Pubs_all.txt using an XSLT that pulled the following fields into a text-based format:
...
-----------------------------------------
DATA-SPECIFIC INFORMATION FOR: allrecords_oct292020.xml
-----------------------------------------
