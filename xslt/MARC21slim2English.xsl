...
<xsl:output method="html"/>
	...
	<xsl:template match="marc:datafield[@tag=049]">
		<p>HOLDING LIBRARY
		</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
	...
	<xsl:template match="marc:datafield[@tag=904]">
		<p>LOCAL DATA
		</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
	...
	<xsl:template match="marc:datafield[@tag=956]">
		<p>LOCAL ELECTRONIC LOCATION AND ACCESS
		</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li><xsl:value-of select="text()"/></li>
	...
	<xsl:template match="marc:datafield[@tag=994]">
		<p>OCLC-MARC TRANSACTION CODE
		</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li><xsl:value-of select="text()"/></li>
