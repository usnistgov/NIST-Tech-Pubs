                    ...
                    <xsl:choose>
                        <xsl:when test="$report-type = 'home'">
                            <section id="content">
                                ...
                                <h2 class="contact">Note</h2>
                                <p>Publication lists on this site are created using DOI metadata. The information is presented in HTML for ease of viewing. If you would like to search, sort, or filter publications please view the <a href="./xml/">Raw Data</a> or search the <a href="https://nist.primo.exlibrisgroup.com/discovery/search?vid=01NIST_INST:01NIST">NIST Research Library</a>.</p>
