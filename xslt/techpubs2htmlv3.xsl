            ...
            <body>
                ...
                <div id="container">
                            ...
                            <section id="content">
                                <xsl:for-each-group select="query" group-by="@key">
                                    ...
                                    <xsl:for-each select="current-group()">
                                        <xsl:sort select="doi_record/report-paper/report-paper_metadata/publication_date/year" order="descending" />
                                        <xsl:sort select="doi_record/report-paper/report-paper_metadata/publication_date/month" order="descending" />
                                        <xsl:sort select="doi_record/report-paper/report-paper_metadata/publication_date/date" order="descending" />
                        ...
                        <xsl:when test="$report-type = 'date'">
                            <section id="content">
                                <xsl:apply-templates select="query">
                                    ...
                                    <xsl:sort order="descending" select="doi_record/report-paper/report-paper_metadata/publication_date/date"/>
                                </xsl:apply-templates>
                            </section>
                        </xsl:when>
                        <xsl:otherwise>
                    ...
                    <aside id="sidebar"> 
                        ...
                        <p><a href="./FIPS.html">Federal Information Processing Standards Publications</a></p>
                        <p><a href="./GCR.html">Grant/Contractor Reports</a></p>
                        <p><a href="./HB.html">Handbooks</a></p>
                        <p><a href="./IR.html">Interagency/Internal Reports</a></p>
                        <p><a href="./MONO.html">Monographs</a></p>
                        <p><a href="./MP.html">Miscellaneous Publications</a></p>
                        <p><a href="./NCSTAR.html">National Construction Safety Team Act Reports</a></p>
